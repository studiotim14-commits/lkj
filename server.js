document.addEventListener('DOMContentLoaded', () => {
  // Автоматический выбор адреса сервера (локально или продакшн)
  const BACKEND_URL = window.location.origin.includes('https://projactx.netlify.app/') || window.location.origin.includes('127.0.0.1')
    ? 'https://projactx.netlify.app/'
  ...
  if (savedUsername && !isGuest) {
    ...
    // Подмена картинки PlayerImageHolder на PlayerHolder.png для авторизованного игрока
